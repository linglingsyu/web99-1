...
(3, '管理登入', 'index.php?do=login', 0, 1),
(4, '網站首頁', 'index.php', 0, 1),
(5, '這是次選單', 'index.php', 3, 1),
(6, '這是次選單2', 'index.php', 3, 1),
(7, 'hgfhgf', 'iulutl', 4, 1),
(8, 'iluytlitil', 'yurytiuri', 4, 1),
(10, 'aaaa', 'index.php', 3, 1),
(12, 'gfadfhgadfh', 'fgadfg', 3, 1);
...
(1, '01B01.jpg', '科技大學校園資訊管理系統', 0),
(2, '01B03.jpg', 'test替代文字', 1),
(10, '01B02.jpg', 'orange', 0);
